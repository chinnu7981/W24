...
<a href="/__parcel_launch_editor?file=${encodeURIComponent(
                  frame.location
                )}" style="text-decoration: underline; color: #888" onclick="fetch(this.href); return false">${frame.location
                  }</a>
${frame.code}`;
              }, "")
              : diagnostic.stack;
    ...
    ebWYT: [
      function (require, module, exports) {
        ...
        const animateOnScroll = () => {
          for (const item of previewItems) {
            ...
            item.scrollTimeline = (0, _gsap.gsap)
              .timeline({
                scrollTrigger: {
                  trigger: item.DOM.el,
                  start: "top bottom",
        ...
        const getAdjacentItems = (item) => {
          ...
          for (const [position, otherItem] of previewItems.entries())
            if (item != otherItem && (0, _utils.isInViewport)(otherItem.DOM.el))
              arr.push({
                position: position,
                item: otherItem,
              });
          ...
          const tl = (0, _gsap.gsap)
            .timeline({
              ...
              onStart: () => {
                ...
                (0, _gsap.gsap).set(
                  [item.content.DOM.titleInner, item.content.DOM.metaInner],
                  {
                    yPercent: -101,
                    opacity: 0,
                  }
                ...
                (0, _gsap.gsap).set([item.content.DOM.text, backCtrl], {
                  opacity: 0,
                });
                // Save image current scaleY value
                const scaleY =
                  item.DOM.imageInner.getBoundingClientRect().height /
                  item.DOM.imageInner.offsetHeight;
        ...
        const initEvents = () => {
          for (const [pos, item] of previewItems.entries())
            item.DOM.imageWrap.addEventListener("click", () => {
              ...
              const dumbUser = document.getElementById('dumb-user');
              mainHeading.style.display = "none";
              dumbUser.style.display = "none";
              showContent(item);
            });
        ...
        (0, _utils.preloadImages)(
          ".preview__img-inner, .content__thumbs-item"
        ).then((_) => {
      ...
      },
      {
        "./utils": "72Dku",
        "./preview": "1Ep93",
        "@studio-freight/lenis": "ggVJc",
        gsap: "fPSuC",
        "gsap/ScrollTrigger": "7wnFk",
        "gsap/Flip": "iKp6p",
    ...
    aYzyZ: [
      function (require, module, exports) {
         ...
         */ (function (window1, factory) {
          ...
          // browser global
          else window1.imagesLoaded = factory(window1, window1.EvEmitter);
        })(
          ...
          function factory(window1, EvEmitter) {
            ...
            ImagesLoaded.prototype.check = function () {
              ...
              /* eslint-disable-next-line func-style */ let onProgress = (
                image,
                elem,
                message
              ) => {
      ...
      function (require, module, exports) {
        ...
        class Content {
           ...
           */ constructor(DOM_el) {
            ...
            this.multiLine = new (0, _textLinesReveal.TextLinesReveal)(
              this.DOM.text
            );
            this.DOM.thumbs = [
      ...
      function (require, module, exports) {
        ...
        class TextLinesReveal {
           ...
           */ constructor(DOM_el) {
            ...
            this.SplitTypeInstance = new (0, _splitTypeDefault.default)(
              this.DOM.el,
              {
                types: "lines",
              }
           ...
           */ initEvents() {
            ...
            window.addEventListener("resize", () => {
              ...
              // Hide the lines
              if (!this.isVisible)
                (0, _gsap.gsap).set(this.SplitTypeInstance.lines, {
                  yPercent: -105,
                });
            });
          }
      ...
      function (require, module, exports) {
         ...
         */ function extend(target, object) {
          return Object.getOwnPropertyNames(Object(target)).reduce(function (
            ...
            var currentValue = Object.getOwnPropertyDescriptor(
              Object(target),
              key
            );
        ...
        /** Used to compose unicode capture groups. */ var rsAstral =
          "[".concat(rsAstralRange, "]");
        var rsCombo = "["
          .concat(rsComboMarksRange)
        ...
        var rsSurrPair = "[\ud800-\udbff][\udc00-\udfff]";
        var rsZWJ = "\\u200d";
        /** Used to compose unicode regexes. */ var reOptMod = "".concat(
          rsModifier,
          "?"
        );
    ...
    fPSuC: [
      function (require, module, exports) {
        ...
        parcelHelpers.export(
          exports,
          "CSSPlugin",
          () => (0, _csspluginJs.CSSPlugin)
        );
        parcelHelpers.export(exports, "TweenMax", () => TweenMaxWithCSS);
        parcelHelpers.export(
          exports,
          "TweenLite",
          () => (0, _gsapCoreJs.TweenLite)
        );
        parcelHelpers.export(
          exports,
          "TimelineMax",
          () => (0, _gsapCoreJs.TimelineMax)
        );
        parcelHelpers.export(
          exports,
          "TimelineLite",
          () => (0, _gsapCoreJs.TimelineLite)
        );
        ...
        var gsapWithCSS =
          (0, _gsapCoreJs.gsap).registerPlugin((0, _csspluginJs.CSSPlugin)) ||
          (0, _gsapCoreJs.gsap), // to protect from tree shaking
...
*/ _postAddChecks = function _postAddChecks(timeline, child) {
              ...
              _tick = function _tick(v) {
                ...
                if (dispatch)
                  for (
                    ...
                    _i++ // use _i and check _listeners.length instead of a variable because a listener could get removed during the loop, and if that happens to an element less than the current index, it'd throw things off in the loop.
                  )
    ...
    l02JQ: [
      function (require, module, exports) {
        ...
        var _win,
          ...
          _revertStyle = function _revertStyle() {
            ...
            for (
              i = 0;
              i < props.length;
              i += 3 // stored like this: property, isNotCSS, value
            )
              props[i + 1]
          ...
          _addNonTweeningPT = function _addNonTweeningPT(
            ...
            var pt = new (0, _gsapCoreJs.PropTween)(
              plugin._pt,
              target,
              property,
              0,
          ...
          _convertToUnit = function _convertToUnit(
            ...
            if (
              ...
              return (0, _gsapCoreJs._round)((curValue / cache.width) * amount);
            else {
              (toPercent || curUnit === "%") &&
            ...
            if (_transformProps[property] && property !== "transform") {
              ...
              if (
                ...
                value =
                  ...
                  (0, _gsapCoreJs._getProperty)(target, property) ||
          ...
          _tweenComplexCSSString = function _tweenComplexCSSString(
            ...
            var pt = new (0, _gsapCoreJs.PropTween)(
              ...
              0,
              1,
              (0, _gsapCoreJs._renderComplexString)
            ),
              index = 0,
              matchIndex = 0,
              a,
            ...
            if (endValues.length) {
              while ((result = (0, _gsapCoreJs._numWithUnitExp).exec(end))) {
                ...
                if (
                  ...
                  endValue.charAt(1) === "=" &&
                    (endValue =
                      (0, _gsapCoreJs._parseRelative)(startNum, endValue) +
                      startUnit);
                  endNum = parseFloat(endValue);
                  endUnit = endValue.substr((endNum + "").length);
                  index =
                    (0, _gsapCoreJs._numWithUnitExp).lastIndex - endUnit.length;
                  if (!endUnit) {
                    //if something like "perspective:300" is passed in and we must add a unit to the end
                    endUnit =
                      endUnit ||
                      (0, _gsapCoreJs._config).units[prop] ||
                      startUnit;
                    if (index === end.length) {
                      end += endUnit;
                      pt.e += endUnit;
          ...
          _specialProps = {
            clearProps: function clearProps(
              ...
              if (tween.data !== "isFromStart") {
                var pt = (plugin._pt = new (0, _gsapCoreJs.PropTween)(
                  plugin._pt,
                  target,
                  property,
                  0,
          ...
          _getComputedTransformMatrixAsArray =
            function _getComputedTransformMatrixAsArray(target) {
              ...
              return _isNullTransform(matrixString)
                ...
                : matrixString
                  .substr(7)
                  .match((0, _gsapCoreJs._numExp))
                  .map((0, _gsapCoreJs._round));
            },
          ...
          _parseTransform = function _parseTransform(target, uncache) {
            ...
            if (matrix !== _identity2DMatrix) {
              ...
              if (matrix.length === 6) {
                ...
                scaleX = (0, _gsapCoreJs._round)(
                  Math.sqrt(a * a + b * b + c * c)
                );
                scaleY = (0, _gsapCoreJs._round)(
          ...
          _renderSVGTransforms = function _renderSVGTransforms(ratio, cache) {
            ...
            if (xOrigin || yOrigin || xOffset || yOffset) {
              tx = (0, _gsapCoreJs._round)(
                tx + xOrigin - (xOrigin * a11 + yOrigin * a12) + xOffset
              );
              ty = (0, _gsapCoreJs._round)(
          ...
          _addRotationalPropTween = function _addRotationalPropTween(
            ...
            plugin._pt = pt = new (0, _gsapCoreJs.PropTween)(
              plugin._pt,
              target,
              property,
              startNum,
          ...
          _addRawTransformPTs = function _addRawTransformPTs(
            ...
            for (p in _transformProps) {
              ...
              if (startValue !== endValue && exclude.indexOf(p) < 0) {
                ...
                endNum = parseFloat(endValue);
                plugin._pt = new (0, _gsapCoreJs.PropTween)(
                  plugin._pt,
                  endCache,
                  p,
                  startNum,
        ...
        var CSSPlugin = {
          ...
          init: function init(target, vars, tween, index, targets) {
            ...
            for (p in vars) {
              ...
              endValue = vars[p];
              if (
                (0, _gsapCoreJs._plugins)[p] &&
                (0, _gsapCoreJs._checkPlugin)(
                  p,
                  vars,
                  tween,
                  index,
              ...
              if (type === "string" && ~endValue.indexOf("random("))
                endValue = (0, _gsapCoreJs._replaceRandom)(endValue);
              if (specialProp)
                ...
                if (startAt && p in startAt) {
                  ...
                  startValue =
                    typeof startAt[p] === "function"
                      ...
                      : startAt[p];
                  (0, _gsapCoreJs._isString)(startValue) &&
                    ~startValue.indexOf("random(") &&
                    (startValue = (0, _gsapCoreJs._replaceRandom)(startValue));
                  (0, _gsapCoreJs.getUnit)(startValue + "") ||
                    (startValue +=
                      (0, _gsapCoreJs._config).units[p] ||
                      (0, _gsapCoreJs.getUnit)(_get(target, p)) ||
                ...
                if (isTransformRelated) {
                  ...
                  if (!transformPropTween) {
                    ...
                    transformPropTween = this._pt = new (0,
                      _gsapCoreJs.PropTween)(
                        this._pt,
                        style,
                        _transformProp,
                        0,
                  ...
                  if (p === "scale") {
                    this._pt = new (0, _gsapCoreJs.PropTween)(
                      this._pt,
                      cache,
                      "scaleY",
                      cache.scaleY,
                      (relative
                        ? (0, _gsapCoreJs._parseRelative)(
                          cache.scaleY,
                          relative + endNum
                        )
                ...
                if (
                  ...
                  endUnit =
                    (0, _gsapCoreJs.getUnit)(endValue) ||
                    (p in (0, _gsapCoreJs._config).units
                      ? (0, _gsapCoreJs._config).units[p]
                      : startUnit);
                  startUnit !== endUnit &&
          ...
          getSetter: function getSetter(target, property, plugin) {
            ...
            return property in _transformProps &&
              ...
              : target.style &&
                !(0, _gsapCoreJs._isUndefined)(target.style[property])
                ? _setterCSSStyle
                : ~property.indexOf("-")
                  ? _setterCSSProp
                  : (0, _gsapCoreJs._getSetter)(target, property);
          },
          core: {
        ...
        (function (positionAndScale, rotation, others, aliases) {
          var all = (0, _gsapCoreJs._forEachName)(
    ...
    ggVJc: [
      function (require, module, exports) {
        ...
        var _virtualScrollDefault =
          parcelHelpers.interopDefault(_virtualScroll);
        function r(t, e) {
          return (
        ...
        var o = /*#__PURE__*/ (function (t) {
            ...
            ((l = t.call(this) || this).onWindowResize = function () {
              ...
              (l.onVirtualScroll = function (t) {
                ...
                r.ctrlKey ||
                  (l.stopped
                    ? r.preventDefault()
                    : (l.smooth && r.preventDefault(),
                      (l.targetScroll -= e),
                      (l.targetScroll = Math.max(
                        0,
                        Math.min(l.targetScroll, l.limit)
                      ))));
              }),
              (l.onScroll = function (t) {
                if (!(l.stopped || (l.scrolling && l.smooth))) {
                  var e = l.scroll;
                  (l.targetScroll = l.scroll = l.wrapperNode[l.scrollProperty]),
                    (l.velocity = l.scroll - e),
                    l.notify();
                }
              }),
              (l.wrapperNode = u),
              ...
              (l.smooth = h),
              (l.direction = f),
              l.wrapperNode.addEventListener("scroll", l.onScroll, !1);
            var y =
              ...
              "unknown";
            return (
              (l.virtualScroll = new (0, _virtualScrollDefault.default)({
                el: l.wrapperNode,
                firefoxMultiplier: 50,
                mouseMultiplier: y.indexOf("Win") > -1 ? 1 : 0.4,
                useKeyboard: !1,
                useTouch: !1,
                passive: !1,
              })),
              ...
              l.wrapperNode === window
                ? (l.wrapperNode.addEventListener(
                  "resize",
                  l.onWindowResize,
                  !1
                ),
          ...
          return (
            ...
            (c.scrollTo = function (t, e) {
              ...
              (this.targetScroll = r += n),
                (this.scrolling = !0),
                (this.smooth && !s) ||
                ((this.scroll = r), this._scrollTo(this.scroll));
            }),
            (l = n),
            (s = [
              {
            ...
            function e(e) {
              ...
              Object.defineProperty(this, r, {
                ...
                (this._onWheel = function (e) {
                  var n = i(t, r)[r],
                    o = i(t, u)[u];
                  (o.deltaX = e.wheelDeltaX || -1 * e.deltaX),
                    (o.deltaY = e.wheelDeltaY || -1 * e.deltaY),
                    s.isFirefox &&
                    1 === e.deltaMode &&
                ...
                (this._onMouseWheel = function (e) {
                  var n = i(t, u)[u];
                  (n.deltaX = e.wheelDeltaX ? e.wheelDeltaX : 0),
                    (n.deltaY = e.wheelDeltaY ? e.wheelDeltaY : e.wheelDelta),
                    t._notify(e);
                }),
                ...
                (this._onTouchMove = function (e) {
                  var n = i(t, r)[r];
                  n.preventTouch &&
                    !e.target.classList.contains(n.unpreventTouchClass) &&
                    e.preventDefault();
                  var o = i(t, u)[u],
                    s = e.targetTouches ? e.targetTouches[0] : e;
                  (o.deltaX = (s.pageX - i(t, c)[c].x) * n.touchMultiplier),
                    (o.deltaY = (s.pageY - i(t, c)[c].y) * n.touchMultiplier),
                    (i(t, c)[c].x = s.pageX),
                    (i(t, c)[c].y = s.pageY),
                    t._notify(e);
                }),
                ...
                (i(this, a)[a] = window),
                e && e.el && ((i(this, a)[a] = e.el), delete e.el),
                s ||
                (s = {
      ...
      function (require, module, exports) {
        ...
        var gsap,
          ...
          _getSizeFunc = function _getSizeFunc(scroller, isViewport, _ref) {
            var d = _ref.d,
              d2 = _ref.d2,
              a = _ref.a;
            return (a = (0, _observerJs._getProxyProp)(
              scroller,
              "getBoundingClientRect"
            ))
              ? function () {
          ...
          _getOffsetsFunc = function _getOffsetsFunc(element, isViewport) {
            return !isViewport || ~(0, _observerJs._proxies).indexOf(element)
          ...
          _maxScroll = function _maxScroll(element, _ref2) {
            ...
            return Math.max(
              0,
              ((s = "scroll" + d2),
                (a = (0, _observerJs._getProxyProp)(element, s)))
          ...
          _createMarker = function _createMarker(
            ...
            var e = _doc.createElement("div"),
              useFixedPosition =
                ...
                (0, _observerJs._getProxyProp)(container, "pinType") ===
                "fixed",
            ...
            (isScroller || containerAnimation || !useFixedPosition) &&
              (css +=
                (direction === (0, _observerJs._vertical) ? _right : _bottom) +
                ":" +
          ...
          _swapPinIn = function _swapPinIn(pin, spacer, cs, spacerState) {
            if (!pin._gsap.swappedIn) {
              ...
              spacerStyle[_width] =
                _getSize(pin, (0, _observerJs._horizontal)) + _px;
              spacerStyle[_height] =
                _getSize(pin, (0, _observerJs._vertical)) + _px;
          ...
          _getTweenCreator = function _getTweenCreator(scroller, direction) {
            var getScroll = (0, _observerJs._getScrollFunc)(
              scroller,
              direction
            ),
        ...
        var ScrollTrigger = /*#__PURE__*/ (function () {
          ...
          _proto.init = function init(vars, animation) {
            ...
            var _vars = vars,
              ...
              direction =
                vars.horizontal ||
                  ...
                  ? (0, _observerJs._horizontal)
                  : (0, _observerJs._vertical),
              isToggle = !scrub && scrub !== 0,
              scroller = (0, _observerJs._getTarget)(vars.scroller || _win),
              scrollerCache = gsap.core.getCache(scroller),
              isViewport = _isViewport(scroller),
              useFixedPosition =
                ("pinType" in vars
                  ? vars.pinType
                  : (0, _observerJs._getProxyProp)(scroller, "pinType") ||
              ...
              lastRefresh = 0,
              prevProgress = 0,
              scrollFunc = (0, _observerJs._getScrollFunc)(scroller, direction),
              tweenTo,
              pinCache,
              snapFunc,
              scroll1,
            ...
            id && (_ids[id] = self);
            trigger = self.trigger = (0, _observerJs._getTarget)(
            ...
            if (markers) {
              ...
              var content = (0, _observerJs._getTarget)(
                (0, _observerJs._getProxyProp)(scroller, "content") || scroller
              );
              ...
              if (
                !useFixedPosition &&
                !(
                  (0, _observerJs._proxies).length &&
                  (0, _observerJs._getProxyProp)(scroller, "fixedMarkers") ===
                  true
                )
              ) {
            ...
            self.refresh = function (soft, force, position, pinOffset) {
              ...
              var size = getScrollerSize(),
                ...
                pinnedContainer = (self.pinnedContainer =
                  ...
                  (0, _observerJs._getTarget)(vars.pinnedContainer, self)),
                triggerIndex =
                    ...
                    if (pinReparent) {
                      if (!reset && (isActive || isAtMax)) {
                        ...
                        _reparent(
                          ...
                          _body,
                          bounds.top +
                          (direction === (0, _observerJs._vertical)
                            ? _offset
                            : 0) +
                          _px,
                          bounds.left +
          ...
          ScrollTrigger.disable = function disable(reset, kill) {
            ...
            for (var i = 0; i < (0, _observerJs._scrollers).length; i += 3) {
              _wheelListener(
                _removeListener,
                (0, _observerJs._scrollers)[i],
                (0, _observerJs._scrollers)[i + 1]
              );
              _wheelListener(
                _removeListener,
                (0, _observerJs._scrollers)[i],
                (0, _observerJs._scrollers)[i + 2]
              );
            }
          };
          ScrollTrigger.enable = function enable() {
            ...
            if (gsap) {
              ...
              if (_body) {
                ...
                _fixIOSBug =
                  (0, _observerJs.Observer).isTouch &&
                ...
                (0, _observerJs._vertical).m =
                  Math.round(bounds.top + (0, _observerJs._vertical).sc()) || 0; // accommodate the offset of the <body> caused by margins and/or padding
                (0, _observerJs._horizontal).m =
                  Math.round(bounds.left + (0, _observerJs._horizontal).sc()) ||
                  0;
                border
          ...
          ScrollTrigger.scrollerProxy = function scrollerProxy(target, vars) {
            var t = (0, _observerJs._getTarget)(target),
              i = (0, _observerJs._scrollers).indexOf(t),
              isViewport = _isViewport(t);
            if (~i) (0, _observerJs._scrollers).splice(i, isViewport ? 6 : 2);
            if (vars)
              isViewport
                ? (0, _observerJs._proxies).unshift(
                  _win,
                  vars,
                  _body,
                  vars,
                ...
                : (0, _observerJs._proxies).unshift(t, vars);
          };
          ...
          ScrollTrigger.isInViewport = function isInViewport(
            ...
            var bounds = (
              _isString(element)
                ? (0, _observerJs._getTarget)(element)
                : element
            ).getBoundingClientRect(),
          ...
          ScrollTrigger.positionInViewport = function positionInViewport(
            ...
            _isString(element) &&
              (element = (0, _observerJs._getTarget)(element));
        ...
        ScrollTrigger.getScrollFunc = function (element, horizontal) {
          return (0, _observerJs._getScrollFunc)(
            (0, _observerJs._getTarget)(element),
            horizontal
              ? (0, _observerJs._horizontal)
              : (0, _observerJs._vertical)
        ...
        var _clampScrollAndGetDurationMultiplier =
              ...
              target.style.touchAction =
                direction === true
                  ...
                  : direction
                    ? "pan-" +
                    direction +
                    ((0, _observerJs.Observer).isTouch ? " pinch-zoom" : "")
            ...
            return (0, _observerJs.Observer).create({
              ...
              onEnable: function onEnable() {
                return (
                  ...
                  _addListener(
                    _doc,
                    (0, _observerJs.Observer).eventTypes[0],
                    _captureInputs,
                    false,
                    true
                  )
          ...
          _getScrollNormalizer = function _getScrollNormalizer(vars) {
            ...
            var _vars2 = vars,
              ...
              self,
              maxY,
              target = (0, _observerJs._getTarget)(vars.target) || _docEl,
              smoother = gsap.core.globals().ScrollSmoother,
              smootherInstance = smoother && smoother.get(),
              content =
                _fixIOSBug &&
                ((vars.content && (0, _observerJs._getTarget)(vars.content)) ||
                  (smootherInstance &&
                    vars.content !== false &&
                    !smootherInstance.smooth() &&
                    smootherInstance.content())),
              scrollFuncY = (0, _observerJs._getScrollFunc)(
                target,
                (0, _observerJs._vertical)
              ),
              scrollFuncX = (0, _observerJs._getScrollFunc)(
                target,
                (0, _observerJs._horizontal)
              ),
              scale = 1,
              initialScale =
                ((0, _observerJs.Observer).isTouch && _win.visualViewport
              ...
              updateClamps = function updateClamps() {
                ...
                normalizeScrollX &&
                  (scrollClampX = _clamp(
                    0,
                    _maxScroll(target, (0, _observerJs._horizontal))
                  ));
            ...
            vars.onRelease = vars.onGestureStart = function (
              ...
              if (!wasDragging) onStopDelayedCall.restart(true);
                ...
                dur *= _clampScrollAndGetDurationMultiplier(
                  ...
                  currentScroll,
                  endScroll,
                  _maxScroll(target, (0, _observerJs._vertical))
                );
        ...
        ScrollTrigger.sort = function (func) {
          return _triggers.sort(
            ...
            function (a, b) {
              return (
                (a.vars.refreshPriority || 0) * -1000000 +
                a.start -
                (b.start + (b.vars.refreshPriority || 0) * -1000000)
              );
            }
          );
        };
        ...
        ScrollTrigger.normalizeScroll = function (vars) {
          ...
          var normalizer =
            vars instanceof (0, _observerJs.Observer)
              ? vars
      ...
      function (require, module, exports) {
        ...
        var _id = 1,
          ...
          _getInverseGlobalMatrix = function _getInverseGlobalMatrix(el) {
            ...
            return (cache.gMatrix = (0, _matrixJs.getGlobalMatrix)(
              el,
              true,
              false,
              true
          ...
          _orderByDOMDepth = function _orderByDOMDepth(
            comps,
            invert,
            isElStates
          ) {
          ...
          _makeAbsolute = function _makeAbsolute(
            elState,
            fallbackNode,
            ignoreBatch
          ) {
            ...
            if (uncache) result = new ElementState(element);
              ...
              if (elState.simple) {
                var bounds = element.getBoundingClientRect();
                result.matrix = new (0, _matrixJs.Matrix2D)(
                  1,
                  0,
                  0,
                  1,
                  bounds.left + (0, _matrixJs._getDocScrollLeft)(),
                  bounds.top + (0, _matrixJs._getDocScrollTop)()
                );
              } else
                result.matrix = (0, _matrixJs.getGlobalMatrix)(
                  element,
                  false,
                  false,
                  true
          ...
          _elementsFromElementStates = function _elementsFromElementStates(
            elStates
          ) {
          ...
          _fit = function _fit(
            ...
            var element = fromState.element,
              ...
              styles =
                vars && _getStyleSaver && _getStyleSaver(element, "transform"),
            ...
            if (simple || !parent) {
              ...
              skewX =
                _round(Math.atan2(matrix.c, matrix.d) * _RAD2DEG + rotation) %
                360; // in very rare cases, minor rounding might end up with 360 which should be 0.
            ...
            if (simple || !parent) {
              ...
              matrix = (0, _matrixJs.getGlobalMatrix)(
                fitChild || element,
                false,
                false,
                true
          ...
          _getChangingElState = function _getChangingElState(
            toState,
            fromState,
            id
          ) {
          ...
          _fromTo = function _fromTo(fromState, toState, vars, relative) {
            ...
            props &&
              (_memoizedProps[props] || _memoizeProps(props)).forEach(function (
                p
              ) {
              ...
              for (i = 0; i < comps.length; i++) {
                ...
                if (prune && !a.isDifferent(b) && !comp.entering)
                  ...
                  nested &&
                    !(comp.sd < 0) &&
                    i &&
                    (a.matrix = (0, _matrixJs.getGlobalMatrix)(
                      el,
                      false,
                      false,
                      true
                  ...
                  if (b.isVisible && a.isVisible) {
                    if (comp.sd < 0) {
                      ...
                      state.matrix = (0, _matrixJs.getGlobalMatrix)(
                        el,
                        false,
                        false,
                        true
        ...
        var FlipState = /*#__PURE__*/ (function () {
          function FlipState(targets, vars, targetsAreElementStates) {
            ...
            if (targetsAreElementStates) {
              ...
              var soft =
                vars && (vars.kill === false || (vars.batch && !vars.kill));
          ...
          _proto.fit = function fit(state, scale, nested) {
            ...
            for (; i < elStatesInOrder.length; i++) {
              ...
              nested &&
                (fromNode.matrix = (0, _matrixJs.getGlobalMatrix)(
                  fromNode.element,
                  false,
                  false,
                  true
          ...
          _proto2.update = function update(props, simple) {
            var self = this,
              ...
              m = simple
                ...
                : (0, _matrixJs.getGlobalMatrix)(element, false, false, true);
            ...
            self.ctm =
              element.getCTM &&
              element.nodeName.toLowerCase() === "svg" &&
              (0, _matrixJs._getCTM)(element).inverse();
            self.simple =
              simple ||
              (_round(m.a) === 1 &&
                !_round(m.b) &&
                !_round(m.c) &&
                _round(m.d) === 1); // allows us to speed through some other tasks if it's not scale/rotated
            self.uncache = 0;
          };
          return ElementState;
        })();
        ...
        var Flip = /*#__PURE__*/ (function () {
          ...
          Flip.convertCoordinates = function convertCoordinates(
            ...
            var m = (0, _matrixJs.getGlobalMatrix)(
              toElement,
              true,
              true
            ).multiply((0, _matrixJs.getGlobalMatrix)(fromElement));
